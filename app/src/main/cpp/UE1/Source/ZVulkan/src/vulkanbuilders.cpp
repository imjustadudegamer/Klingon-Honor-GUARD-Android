...
// [KHG] glslang excluded for the Android build (we load precompiled SPIR-V). The whole ShaderBuilder
// (runtime GLSL->SPIR-V) is fenced behind ZVULKAN_ENABLE_GLSLANG, which we never define.
#ifdef ZVULKAN_ENABLE_GLSLANG
