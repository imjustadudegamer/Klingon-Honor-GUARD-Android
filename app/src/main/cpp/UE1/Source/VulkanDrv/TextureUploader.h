...
struct FTextureInfo;
// FMipmapBase is provided by Precomp.h (typedef FMipmap FMipmapBase) for build-219 — do not forward
// declare it as a struct here (that clashes with the typedef).
enum ETextureFormat;
