...
TextureUploader* TextureUploader::GetUploader(ETextureFormat format)
{
	...
	if (Uploaders.empty())
	{
		...
		// ETC1/ETC2/EAC.
		//Uploaders[TEXF_ETC1].reset(new TextureUploader_4x4Block(VK_FORMAT_ETC1_R8G8B8_UNORM_BLOCK, 8));
		Uploaders[TEXF_ETC2].reset(new TextureUploader_4x4Block(VK_FORMAT_ETC2_R8G8B8_UNORM_BLOCK, 8));
		Uploaders[TEXF_ETC2_PA].reset(new TextureUploader_4x4Block(VK_FORMAT_ETC2_R8G8B8A1_UNORM_BLOCK, 8));
		Uploaders[TEXF_ETC2_RGB_EAC_A].reset(new TextureUploader_4x4Block(VK_FORMAT_ETC2_R8G8B8A8_UNORM_BLOCK, 16));
		Uploaders[TEXF_EAC_R].reset(new TextureUploader_4x4Block(VK_FORMAT_EAC_R11_UNORM_BLOCK, 8));
		Uploaders[TEXF_EAC_R_S].reset(new TextureUploader_4x4Block(VK_FORMAT_EAC_R11_SNORM_BLOCK, 8));
		Uploaders[TEXF_EAC_RG].reset(new TextureUploader_4x4Block(VK_FORMAT_EAC_R11G11_UNORM_BLOCK, 16));
		Uploaders[TEXF_EAC_RG_S].reset(new TextureUploader_4x4Block(VK_FORMAT_EAC_R11G11_SNORM_BLOCK, 16));

		// ASTC.
		Uploaders[TEXF_ASTC_4x4].reset(new TextureUploader_2DBlock(VK_FORMAT_ASTC_4x4_UNORM_BLOCK, 4, 4, 16));
		Uploaders[TEXF_ASTC_5x4].reset(new TextureUploader_2DBlock(VK_FORMAT_ASTC_5x4_UNORM_BLOCK, 5, 4, 16));
		Uploaders[TEXF_ASTC_5x5].reset(new TextureUploader_2DBlock(VK_FORMAT_ASTC_5x5_UNORM_BLOCK, 5, 5, 16));
		Uploaders[TEXF_ASTC_6x5].reset(new TextureUploader_2DBlock(VK_FORMAT_ASTC_6x5_UNORM_BLOCK, 6, 5, 16));
		Uploaders[TEXF_ASTC_6x6].reset(new TextureUploader_2DBlock(VK_FORMAT_ASTC_6x6_UNORM_BLOCK, 6, 6, 16));
		Uploaders[TEXF_ASTC_8x5].reset(new TextureUploader_2DBlock(VK_FORMAT_ASTC_8x5_UNORM_BLOCK, 8, 5, 16));
		Uploaders[TEXF_ASTC_8x6].reset(new TextureUploader_2DBlock(VK_FORMAT_ASTC_8x6_UNORM_BLOCK, 8, 6, 16));
		Uploaders[TEXF_ASTC_8x8].reset(new TextureUploader_2DBlock(VK_FORMAT_ASTC_8x8_UNORM_BLOCK, 8, 8, 16));
		Uploaders[TEXF_ASTC_10x5].reset(new TextureUploader_2DBlock(VK_FORMAT_ASTC_10x5_UNORM_BLOCK, 10, 5, 16));
		Uploaders[TEXF_ASTC_10x6].reset(new TextureUploader_2DBlock(VK_FORMAT_ASTC_10x6_UNORM_BLOCK, 10, 6, 16));
		Uploaders[TEXF_ASTC_10x8].reset(new TextureUploader_2DBlock(VK_FORMAT_ASTC_10x8_UNORM_BLOCK, 10, 8, 16));
		Uploaders[TEXF_ASTC_10x10].reset(new TextureUploader_2DBlock(VK_FORMAT_ASTC_10x10_UNORM_BLOCK, 10, 10, 16));
		Uploaders[TEXF_ASTC_12x10].reset(new TextureUploader_2DBlock(VK_FORMAT_ASTC_12x10_UNORM_BLOCK, 12, 10, 16));
		Uploaders[TEXF_ASTC_12x12].reset(new TextureUploader_2DBlock(VK_FORMAT_ASTC_12x12_UNORM_BLOCK, 12, 12, 16));
		//Uploaders[TEXF_ASTC_3x3x3].reset(new TextureUploader_3DBlock(VK_FORMAT_ASTC_3x3x3_UNORM_BLOCK, 3, 3, 3, 16));
		//Uploaders[TEXF_ASTC_4x3x3].reset(new TextureUploader_3DBlock(VK_FORMAT_ASTC_4x3x3_UNORM_BLOCK, 4, 3, 3, 16));
		//Uploaders[TEXF_ASTC_4x4x3].reset(new TextureUploader_3DBlock(VK_FORMAT_ASTC_4x4x3_UNORM_BLOCK, 4, 4, 3, 16));
		//Uploaders[TEXF_ASTC_4x4x4].reset(new TextureUploader_3DBlock(VK_FORMAT_ASTC_4x4x4_UNORM_BLOCK, 4, 4, 4, 16));
		//Uploaders[TEXF_ASTC_5x4x4].reset(new TextureUploader_3DBlock(VK_FORMAT_ASTC_5x4x4_UNORM_BLOCK, 5, 4, 4, 16));
		//Uploaders[TEXF_ASTC_5x5x4].reset(new TextureUploader_3DBlock(VK_FORMAT_ASTC_5x5x4_UNORM_BLOCK, 5, 5, 4, 16));
		//Uploaders[TEXF_ASTC_5x5x5].reset(new TextureUploader_3DBlock(VK_FORMAT_ASTC_5x5x5_UNORM_BLOCK, 5, 5, 5, 16));
		//Uploaders[TEXF_ASTC_6x5x5].reset(new TextureUploader_3DBlock(VK_FORMAT_ASTC_6x5x5_UNORM_BLOCK, 6, 5, 5, 16));
		//Uploaders[TEXF_ASTC_6x6x5].reset(new TextureUploader_3DBlock(VK_FORMAT_ASTC_6x6x5_UNORM_BLOCK, 6, 6, 5, 16));
		//Uploaders[TEXF_ASTC_6x6x6].reset(new TextureUploader_3DBlock(VK_FORMAT_ASTC_6x6x6_UNORM_BLOCK, 6, 6, 6, 16));
		...
		// RGBA (Integral).
		Uploaders[TEXF_R8_UI].reset(new TextureUploader_Simple(VK_FORMAT_R8_UINT, 1));
		Uploaders[TEXF_R8_I].reset(new TextureUploader_Simple(VK_FORMAT_R8_SINT, 1));
		Uploaders[TEXF_R16_UI].reset(new TextureUploader_Simple(VK_FORMAT_R16_UINT, 2));
		Uploaders[TEXF_R16_I].reset(new TextureUploader_Simple(VK_FORMAT_R16_SINT, 2));
		Uploaders[TEXF_R32_UI].reset(new TextureUploader_Simple(VK_FORMAT_R32_UINT, 4));
		Uploaders[TEXF_R32_I].reset(new TextureUploader_Simple(VK_FORMAT_R32_SINT, 4));
		Uploaders[TEXF_RG8_UI].reset(new TextureUploader_Simple(VK_FORMAT_R8G8_UINT, 2));
		Uploaders[TEXF_RG8_I].reset(new TextureUploader_Simple(VK_FORMAT_R8G8_SINT, 2));
		Uploaders[TEXF_RG16_UI].reset(new TextureUploader_Simple(VK_FORMAT_R16G16_UINT, 4));
		Uploaders[TEXF_RG16_I].reset(new TextureUploader_Simple(VK_FORMAT_R16G16_SINT, 4));
		Uploaders[TEXF_RG32_UI].reset(new TextureUploader_Simple(VK_FORMAT_R32G32_UINT, 8));
		Uploaders[TEXF_RG32_I].reset(new TextureUploader_Simple(VK_FORMAT_R32G32_SINT, 8));
		Uploaders[TEXF_RGB8_UI].reset(new TextureUploader_Simple(VK_FORMAT_R8G8B8_UINT, 3));
		Uploaders[TEXF_RGB8_I].reset(new TextureUploader_Simple(VK_FORMAT_R8G8B8_SINT, 3));
		Uploaders[TEXF_RGB16_UI].reset(new TextureUploader_Simple(VK_FORMAT_R16G16B16_UINT, 6));
		Uploaders[TEXF_RGB16_I].reset(new TextureUploader_Simple(VK_FORMAT_R16G16B16_SINT, 6));
		Uploaders[TEXF_RGB32_UI].reset(new TextureUploader_Simple(VK_FORMAT_R32G32B32_UINT, 12));
		Uploaders[TEXF_RGB32_I].reset(new TextureUploader_Simple(VK_FORMAT_R32G32B32_SINT, 12));
		Uploaders[TEXF_RGBA8_UI].reset(new TextureUploader_Simple(VK_FORMAT_R8G8B8A8_UINT, 4));
		Uploaders[TEXF_RGBA8_I].reset(new TextureUploader_Simple(VK_FORMAT_R8G8B8A8_SINT, 4));
		Uploaders[TEXF_RGBA16_UI].reset(new TextureUploader_Simple(VK_FORMAT_R16G16B16A16_UINT, 8));
		Uploaders[TEXF_RGBA16_I].reset(new TextureUploader_Simple(VK_FORMAT_R16G16B16A16_SINT, 8));
		Uploaders[TEXF_RGBA32_UI].reset(new TextureUploader_Simple(VK_FORMAT_R32G32B32A32_UINT, 16));
		Uploaders[TEXF_RGBA32_I].reset(new TextureUploader_Simple(VK_FORMAT_R32G32B32A32_SINT, 16));
...
void TextureUploader_P8::UploadRect(void* d, FMipmapBase* mip, int x, int y, int w, int h, FColor* palette, bool masked)
{
	...
	if (masked)
	{
		...
		for (int i = 0; i < h; i++)
		{
			...
			{
				int idx = src[j];
				if (idx != 0) { FColor c = palette[idx]; c.A = 255; *Ptr++ = c; }
				else          { *Ptr++ = translucent; }
			}
			src += pitch;
		}
	}
	else
	{
		for (int i = 0; i < h; i++)
		{
			...
			{
				int idx = src[j];
				FColor c = palette[idx]; c.A = 255; *Ptr++ = c;
			}
			src += pitch;
		}
	}
